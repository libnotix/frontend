...
```typescript
import type { DraftAiEditDualResponse } from ''
...
} satisfies DraftAiEditDualResponse
...
const exampleParsed = JSON.parse(exampleJSON) as DraftAiEditDualResponse
